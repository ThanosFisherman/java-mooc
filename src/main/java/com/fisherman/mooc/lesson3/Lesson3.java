...
public class Lesson3
{
    ...
    static List<String> processWords(List<String> wordList, boolean parallel)
    {
        ...
        if (parallel)
        {
            newList = wordList.parallelStream()
                              .sorted()
    ...
    public static void main(String[] args) throws IOException, URISyntaxException
    {
        ...
        measure("computeLevenshtein Sequential", () -> computeLevenshtein(wordList, false));
        measure("computeLevenshtein Parallel", () -> computeLevenshtein(wordList, true));

        measure("processWords Sequential", () -> processWords(wordList, false));
